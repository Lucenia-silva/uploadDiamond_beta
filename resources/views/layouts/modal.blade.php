    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header logo">
            <a href="/"><img src="img/logo/diamond/2.png" style="width:20rem; margin-left:5rem;" alt="image"></a>
          </div>
            ...
            <div class="col-md-12 text-center">
             ...
             <form action="" method="post" name="login">
              ...
              <div class="col-md-12 mb-3">
                ...
                <div class="form-group">
                   <p class="text-center">Still not registered?  <a href="#" data-toggle="modal" data-target="#ModalLongoExemplo">Sign up for free</a></p>
                </div>
